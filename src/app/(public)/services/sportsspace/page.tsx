...
export const metadata: Metadata = {
  ...
  description:
    "Explore Nagpur’s leading sports facilities for cricket, football, pickleball, snooker, and PS5 gaming. Book your favorite turf or gaming zone online—ideal for tournaments, corporate events, and private bookings.",
  keywords: [
    "Sports complexes Nagpur Maharashtra",
    "Indoor sports complex Nagpur",
    "Outdoor sports grounds Nagpur",
    "Turf booking Nagpur",
    "Sports arena Nagpur",
    "Cricket ground Nagpur",
    "Football turf Nagpur",
    "Pickleball courts Nagpur",
    "Sports facility booking Nagpur",
    "Sports infrastructure Nagpur Maharashtra",
    "Venue booking sports Nagpur",
    "Managed sports facilities Nagpur",
    "Sports space management Nagpur",
    "Sports space Nagpur",
    "Sports facilities Maharashtra",
    "Turf booking Maharashtra",
    "Indoor sports Nagpur",
    "Sports venue booking",
    "Cricket turf Nagpur",
    "Football ground Maharashtra",
    "Pratigrham sports facilities Nagpur",
    "Pratigrham managed turfs Nagpur",
    "sports complex Nagpur",
    "Nagpur sports grounds booking",
    "Nagpur sports space booking",
    "Sports turf booking Nagpur online",
    "Corporate sports tournament venues Nagpur",
    "Sports arena rental Nagpur",
    "Managed sports courts Nagpur",
    "Premium sports facility Nagpur",
    "Nagpur multi-sports center booking",
    "Sports venue operations Nagpur",
    "Sports facilities Nagpur",
    "Cricket grounds Nagpur city",
    "Football turfs near Nagpur city",
    "Pickleball courts Vidarbha region",
    "Indoor sports venue Nagpur Maharashtra",
    "Outdoor sports complex Nagpur city",
    "Sporting events venue Nagpur",
    "Cricket turf booking Nagpur",
    "Professional cricket facilities Nagpur",
    "Pickleball facility booking Nagpur",
    "Snooker halls Nagpur",
    "Pool table booking Nagpur",
    "Snooker club Nagpur Maharashtra",
    "PS5 gaming zones Nagpur",
    "PlayStation 5 esports arena Nagpur",
    "PS5 gaming center booking Nagpur",
    "Private screening venues Nagpur",
    "Private sports screening Nagpur",
  ],
};
