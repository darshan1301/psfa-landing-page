...
export const metadata: Metadata = {
  title: "Annual Sports Training Program for Schools & Institutes | PSFA ASTP",
  description:
    "Join our Annual Sports Training Program for Schools & Colleges at Sports For All, Nagpur. Get weekly training, assessments, tournaments, and performance dashboards integrated into school timetables.Sports For All offers a comprehensive sports academy with fitness, nutrition, and life skills modules. Manage school sports tournaments, track attendance, and log activities with real-time dashboards.",
  keywords: [
    ...
    "sports coaching",
    "sports facility",
    "annual sports training program for schools",
    "Integrated sports training with dashboards",
    "sports training and assessment programs",
    "sports academy with fitness and nutrition modules",
    "school sports tournament management software",
    "Sports ground and equipment booking in Nagpur",
    "customized sports coaching and training packages",
    "sports infrastructure and facility management services",
    "sports academy with tournaments",
    "sports infrastructure and coaching",
    "sports space for schools",
    "sports kart and equipment",
    "sports training with dashboards",
    "school sports programs",
    "sports training and development",
    "fitness and life skills training in sports",
    "inter-school sports competitions",
    "sports coaching and assessments",
    "team sports training schedule",
    "sports for all",
    ...
    "sports academy services",
    "school sports academy",
    "college sports academy",
    "sports training for students",
    "multi sport program",
    "annual sports training program for colleges",
    "school sports program with tournaments",
    "sports coaching program with assessments",
    "integrated sports program in school timetable",
    "school fitness and sports training program",
    "customizable school sports training solutions",
    "per student per month school sports program",
    "structured sports curriculum for schools and colleges",
  ],
};
