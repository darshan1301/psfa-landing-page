...
export const metadata: Metadata = {
  title:
    "Sports Academy in Nagpur – Football, Cricket, Pickleball Coaching | PSFA",
  description:
    "Join PSFA Sports Academy for structured, coach-led training with fitness, matchplay and quarterly tournaments. Batches for kids, teens & adults.",
  keywords: [
